...
def preprocess_data(x, y, limit, train_size=0.8, sample='train'):
    ...
    five_inde = np.where(y == 5)[0][:limit]
    ...
    all_indices = np.hstack((zero_index, one_index, two_index, tree_index, four_index, five_inde, six_index,
